...
t_index_adapters_native_contract() {
  ...
  assert_contains "$ROOT/scripts/vm/guest/startos-fulcrum.sh" 'install_signet_fulcrum_wrapper'
  assert_contains "$ROOT/scripts/vm/guest/startos-fulcrum.sh" 'patch_fulcrum_package_path_env'
  assert_contains "$ROOT/scripts/vm/guest/startos-fulcrum.sh" 'network=signet'
  ...
  assert_contains "$ROOT/scripts/vm/guest/startos-electrs.sh" 'install_signet_electrs_wrapper'
  assert_contains "$ROOT/scripts/vm/guest/startos-electrs.sh" 'patch_electrs_package_path_env'
  assert_contains "$ROOT/scripts/vm/guest/startos-electrs.sh" 'network = "signet"'
  assert_contains "$ROOT/scripts/vm/guest/startos-adapter.sh" 'ensure_signet_rpc_cookie_alias'
