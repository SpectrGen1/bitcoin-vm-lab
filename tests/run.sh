...
t_bind_readonly() { assert_contains "$ROOT/scripts/vm/guest/startos-adapter.sh" '.RW == false'; ! rg -n 'KNOTS_RELEASE_DIR|bind.*bitcoind' "$ROOT/scripts/vm/guest/umbrel-adapter.sh"; }
